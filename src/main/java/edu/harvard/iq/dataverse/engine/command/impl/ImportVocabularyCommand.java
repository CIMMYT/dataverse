...
public class ImportVocabularyCommand extends AbstractVoidCommand {

    private final Dataverse editedDv;
    private final DataverseControlledVocabulary dataverseControlledVocabulary;

    public ImportVocabularyCommand(DataverseControlledVocabulary dvcv, DataverseRequest aRequest, Dataverse editedDv) {
    ...
    public void executeImpl(CommandContext ctxt) throws CommandException {
        ...
        this.dataverseControlledVocabulary.setIsimport(true);
